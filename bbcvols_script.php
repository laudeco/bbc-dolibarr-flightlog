...
/**
 *      \file       flightLog/bbcvols_script.php
 *		\ingroup    flightLog
...
// Examples for manipulating class bbcvols_class
require_once(DOL_DOCUMENT_ROOT."/../flightLog/bbcvols.class.php");
...
$sql.= " FROM ".MAIN_DB_PREFIX."bbcvols";
