...
// $db->begin();
// $db->query("INSERT INTO `llx_bbc_ballons` (`idBBC_ballons` ,`immat` ,`marraine` ,`fk_responsable`)VALUES (NULL , 'OO-tes', NULL , '0');");
// $db->commit();

// $resql = $db->query("SELECT * FROM llx_bbc_ballons");
// if($resql){
