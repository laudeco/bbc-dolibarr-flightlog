...
class modFlightLog extends DolibarrModules
{
    ...
    public function __construct($db)
    {
        ...
        $this->export_fields_array[$r] = array(
            "flight.idBBC_vols"                => "idBBC_vols",
            "flight.date"                      => "date",
            "flight.lieuD"                     => "lieuD",
            "flight.lieuA"                     => "lieuA",
            "flight.heureD"                    => "heureD",
            "flight.heureA"                    => "heureA",
            "flight.BBC_ballons_idBBC_ballons" => "BBC_ballons_idBBC_ballons",
            "flight.nbrPax"                    => "nbrPax",
            "flight.remarque"                  => "remarque",
            "flight.incidents"                 => "incidents",
            "flight.fk_type"                   => "fk_type",
            "flight.fk_pilot"                  => "fk_pilot",
            "flight.fk_organisateur"           => "fk_organisateur",
            "flight.is_facture"                => "is_facture",
            "flight.kilometers"                => "kilometers",
            "flight.cost"                      => "cost",
            "flight.fk_receiver"               => "fk_receiver",
            "flight.justif_kilometers"         => "justif_kilometers",
        );
