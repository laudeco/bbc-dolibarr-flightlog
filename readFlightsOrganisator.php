...
$sqlByType = "SELECT USR.name AS nom , USR.firstname AS prenom ,COUNT(`idBBC_vols`) AS nbr,fk_organisateur as pilot, TT.numero as type,SEC_TO_TIME(SUM(TIME_TO_SEC(TIMEDIFF(heureA,heureD)))) AS time ";
...
print "<form name='readBalloon' action=\"readFlightsOrganisator.php\" method=\"post\">\n";
    ...
    if ($num) {
        ...
        while ($i < $num) {
            ...
            if ($obj) {
                ...
                print '<td>' . $pilot->getFullName($langs) . '</td>';
